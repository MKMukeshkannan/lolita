...
export class Renderer
{
  public:
    ...
    Res<void> init();
    Res<void> create_window();
    Res<void> setup_imgui();
    Res<void> run(const std::function<void(float)> &draw_frame);
...
Res<void> Renderer::create_window() {
...
Res<void> Renderer::run(const std::function<void(float)> &draw_frame) {
